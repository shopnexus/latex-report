...
Về nhận dạng giọng nói tiếng Việt, các mô hình như PhoWhisper (VinAI) đã đạt 
được độ chính xác đáng kể, tuy nhiên yêu cầu tài nguyên tính toán đáng kể (khoảng 2 GB VRAM).
...
\item \textbf{Phần mềm:} Server trung gian Node.js (relay TCP$\leftrightarrow$WebSocket),
  ...
  (FastAPI + PhoWhisper), dịch vụ phân loại (FastAPI + PyTorch), và giao diện web.
