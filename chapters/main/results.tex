...
\begin{itemize}
\item
  \textbf{Pipeline end-to-end:} Từ thu âm ESP32 $\rightarrow$ khử nhiễu $\rightarrow$ nhận dạng giọng nói
  $\rightarrow$ sinh mô tả $\rightarrow$ phân loại sản phẩm, hoạt động liền mạch.
\item
